...
export default function FooterAnime() {
  return (
    <footer className='flex justify-between relative items-center bg-zinc-200 dark:bg-dark rounded-xl xs:rounded-full ml-28 mt-8 px-4 sm:px-8 py-4 gap-3 text-xs md:text-lg mb-20 md:mb-0'>
